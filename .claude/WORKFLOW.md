# AppsFlyer Roku Sample App — AI Skill Workflow
...
flowchart TD
    ...
    Bob["👨‍🔬 Bob<br/>bob-roku-researcher<br/>Owns: R-NNN docs"]
    Erin["👩‍💻 Erin<br/>erin-roku-analyst<br/>Owns: P-NNN docs"]
    Dave["👨‍💻 Dave<br/>dave-roku-engineer<br/>Owns: HOW + F-NNN docs"]
